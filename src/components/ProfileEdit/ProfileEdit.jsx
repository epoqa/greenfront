...
const ProfileEdit = ({ onHide, user, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        <form>
          ...
          <div className="form-group">
            ...
            <select
              onChange={(e) =>
                setGender(e.target.value === "შეცვლა" ? "none" : e.target.value)
              }
              className="form-control"
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
              id="exampleFormControlInput1"
              defaultValue={user.location === "none" ? "" : user.location}
            />
          </div>
          <br />
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              defaultValue={user.about === "none" ? "" : user.about}
              rows="3"
            ></textarea>
          </div>
      ...
      <Modal.Footer>
        <button onClick={(e) => save()} className="btn btn-success">
          შენახვა
        </button>
